...
class SKColors {
  ...
  static const Color secondarySurface = Color(0xFFFFFCF3);
  static const Color secondaryFocus = Color(0xFFFFF3CD);
  static const Color secondaryBorder = Color(0xFFFFC107);
  static const Color secondaryHover = Color(0xFFD5A106);
  static const Color secondaryPressed = Color(0xFF806003);
